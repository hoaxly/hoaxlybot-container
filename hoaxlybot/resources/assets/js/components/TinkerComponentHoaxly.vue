    ...
    <div>
        ...
        <ul class="ChatLog">
            <li class="ChatLog__entry" v-for="message in messages" :class="{'ChatLog__entry_mine': message.isMine}">
                <img class="ChatLog__avatar" src="/avatar.jpg" />
                <p class="ChatLog__message" v-html="message.text">
                    {{ message.text }}
        ...
        <input type="text" class="ChatInput" @keyup.enter="sendMessage" v-model="newMessage" placeholder="Say hi to me!">
    </div>
</template>
